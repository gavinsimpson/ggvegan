...
# From: https://github.com/tidyverse/ggplot2/blob/main/tests/testthat/helper-vdiffr.R
...
if (
  ...
  # If vdiffr is not available and visual tests are explicitly
  # requested, raise error.
