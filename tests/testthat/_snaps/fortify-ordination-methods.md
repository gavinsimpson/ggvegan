...
# fortify works for dbrda with 1 set of scores

    Code
      fortify(dune_dbrda, layers = "sites")
    Output
      # A tibble: 20 x 8
         score label  dbrda1   dbrda2  dbrda3 dbrda4 dbrda5 dbrda6
         <fct> <chr>   <dbl>    <dbl>   <dbl>  <dbl>  <dbl>  <dbl>
       ...
       9 sites 9     -0.0647 -1.75     2.16    1.63  -1.84  -0.109
      10 sites 10    -1.97    0.718   -1.87   -1.08  -1.78  -2.89 
      11 sites 11    -1.06    1.38    -2.09    0.647 -1.36   3.89 
      12 sites 12     1.18   -1.96     1.75    2.22  -2.49   1.68 
      13 sites 13     0.813  -2.42     0.641   0.648 -0.175 -2.03 
      14 sites 14     1.69    1.09    -1.05   -2.21  -1.93   0.116
      15 sites 15     1.93    1.09     0.335  -1.74   0.144  0.533
      16 sites 16     2.82   -0.567    0.0156 -3.23   1.82   0.342
      17 sites 17     0.250   1.88     0.399   1.57   2.24  -1.15 
      18 sites 18    -0.248   2.02     0.107   1.57  -0.382  2.06 
      19 sites 19     0.623   2.41     0.385   3.73  -0.681 -1.83 
      20 sites 20     2.37    1.39     0.540  -0.648  1.54  -0.468

---

    Code
      tidy(dune_dbrda, layers = "sites")
    Output
      # A tibble: 20 x 8
         score label  dbrda1   dbrda2  dbrda3 dbrda4 dbrda5 dbrda6
         <fct> <chr>   <dbl>    <dbl>   <dbl>  <dbl>  <dbl>  <dbl>
