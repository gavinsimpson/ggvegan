##' @title ggplot-based plot for objects of class \code{"rad"}
##'
##' @description Produces a multi-layer ggplot object representing the output of object \code{rad} produced by \code{\link[vegan]{radfit}}, \code{\link[vegan]{rad.null}}, \code{\link[vegan]{rad.preempt}}, \code{\link[vegan]{rad.lognormal}}, \code{\link[vegan]{rad.zipf}} or \code{\link[vegan]{rad.zipfbrot}}.
##'
##' @param object an object of class \code{rad}.
...
`autoplot.rad` <- function(object, log = "y",
